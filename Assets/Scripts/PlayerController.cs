...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Switches the zone the fish travels too, cannot happen while the move button is held and until it's close enough to the tank position. 
        // Pressing the button will switch zones
